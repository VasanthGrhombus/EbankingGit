...
//				driver.switchTo().frame(addcust.popUpFrame);
//				addcust.dismissButton.click();
		logger.info("providing customer details....");


		addcust.custName("Vasanth");
		addcust.custgender("male");
		addcust.custdob("12","27","1996");
		Thread.sleep(5000);
		addcust.custaddress("INDIA");
		addcust.custcity("HYD");
		addcust.custstate("AP");
		addcust.custpinno("522101");
		addcust.custtelephoneno("7893397180");
